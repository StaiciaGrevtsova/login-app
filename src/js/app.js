...
const { formLogin, formLoginInputs, formRegister, formRegisterInputs } = UI;
...
formRegisterInputs.inputCountry.addEventListener("focus", (e) => {
...
async function onSubmitRegister() {
  ...
  if(formData.date_of_birth) {
    const dateOfBirth = formData.date_of_birth.split('.');
    formData.date_of_birth_day = dateOfBirth[0];
    formData.date_of_birth_month = dateOfBirth[1];
    formData.date_of_birth_year = dateOfBirth[2];
  }
